...
namespace Amxx {
    ...
    class Writer {
      public:
         ...
         *
         * @param header \c Amxx::Header structure to write.
         */
         ...
         *
         * @param entry \c Amxx::Entry structure to write.
         */
         ...
         *
         * @tparam T Container type satisfying \c Amxx::EntryContainer.
         *
         ...
         *
         * @tparam T Container type satisfying \c Amxx::BodyContainer.
         *
