...
typedef int jmp_buf[9];
    ...
    #include <dos.h>
unsigned __total_drives; /* dummy variable */
    #define dos_setdrive(i) _dos_setdrive(i, &__total_drives)
 ...
 */
int pc_compile(int argc, const char** argv);
...
SC_VDECL int sc_optproccall;          /* support "procedure call" */
...
SC_VDECL int sc_verbosity;            /* verbosity level, 0=quiet, 1=normal, 2=verbose */
