...
namespace Amx {
    ...
    class Reader {
      public:
         ...
         *
         * @return Parsed \c Amx::Header structure.
         */
         ...
         *
         * @return Parsed \c Amx::HeaderDebug if debug information exists, otherwise \c std::nullopt.
         */
         ...
         *               Defaults to beginning of stream.
         *
         * @return Parsed \c Amx::HeaderDebug structure.
         */
         ...
         *
         * @return Fully populated \c Amx::Data object.
         */
